...
```jsonc
{
  ...
  "skills":     { "<slug>": { "body": "…", "description": "…", "scope": "project|user" } },
  "brains":     { "<slug>": { "soul": "…", "persona": "…", "procedure": "…", "rules": [ … ], "skill_slugs": [ … ], "model": "…" } },
  "state":      { "soul": "…", "persona": "…", "procedure": "…", "rules": [ … ], "skill_slugs": [ … ] }
}
```
...
Imports are additive — existing souls, personas, rules, skills, and brains are upserted in place. Per-entity failures (e.g. dangling references) become warnings and do not abort the import. An unknown `schema_version` is a fatal `BAD_REQUEST`.
