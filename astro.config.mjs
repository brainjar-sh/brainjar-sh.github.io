	...
	integrations: [
		starlight({
			...
			sidebar: [
				...
				{
					label: 'CLI Reference',
					// Autogenerated from the CLI markdown pages synced from
					// the latest brainjar release (see scripts/fetch-cli-docs.sh).
					// One entry per command; Starlight pulls the label from
